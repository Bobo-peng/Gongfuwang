...
function getLodop(oOBJECT, oEMBED) {
    ...
    **************************/
    ...
    try {
        ...
        if (navigator.userAgent.match(/Edge\D?\d+/i) != null) isIE = true;
        var is64IE = isIE && ((navigator.userAgent.indexOf('x64') >= 0) || (navigator.userAgent.indexOf('win64') >= 0) || (navigator.userAgent.indexOf('WOW64') >= 0));
        ...
        LODOP.SET_LICENSES("", "683839998100501001121125612890", "688858710010010811411756128900", "");
